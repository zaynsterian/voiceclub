...
export declare function importKey(keyBytes: NonSharedUint8Array | ArrayBuffer, algorithm?: string | {
    name: string;
...
export declare function createE2EEKey(): NonSharedUint8Array;
/**
 * Ratchets a key. See
 * https://tools.ietf.org/html/draft-omara-sframe-00#section-4.3.5.1
 */
export declare function ratchet(material: CryptoKey, salt: string): Promise<ArrayBuffer>;
export declare function needsRbspUnescaping(frameData: NonSharedUint8Array): boolean;
export declare function parseRbsp(stream: NonSharedUint8Array): NonSharedUint8Array;
export declare function writeRbsp(data_in: NonSharedUint8Array): NonSharedUint8Array;
