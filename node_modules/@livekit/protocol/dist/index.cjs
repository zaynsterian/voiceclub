...
const ChatRole = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const AgentState = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const UserState = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const AmdCategory = /* @__PURE__ */ protobuf.proto3.makeEnum(
  "livekit.agent.AmdCategory",
  [
...
const MetricsReport = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.MetricsReport",
  () => [
    { no: 1, name: "started_speaking_at", kind: "message", T: protobuf.Timestamp },
    { no: 2, name: "stopped_speaking_at", kind: "message", T: protobuf.Timestamp },
...
const TimedString = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.TimedString",
  () => [
    {
      no: 1,
      name: "text",
    ...
    { no: 2, name: "start_time", kind: "scalar", T: 1, opt: true },
    { no: 3, name: "end_time", kind: "scalar", T: 1, opt: true },
    { no: 4, name: "confidence", kind: "scalar", T: 1, opt: true },
    { no: 5, name: "start_time_offset", kind: "scalar", T: 1, opt: true },
    { no: 6, name: "speaker_id", kind: "scalar", T: 9, opt: true }
  ]
);
const ChatMessage$1 = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "role", kind: "enum", T: protobuf.proto3.getEnumType(ChatRole) },
    ...
    { no: 8, name: "created_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const ChatMessage_ChatContent = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const FunctionCall = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "created_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const FunctionCallOutput = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "created_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const AgentHandoff = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "created_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const AgentConfigUpdate = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const ChatContext = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.ChatContext",
  () => [
    { no: 1, name: "items", kind: "message", T: ChatContext_ChatItem, repeated: true }
  ]
);
const ChatContext_ChatItem = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const LLMModelUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const TTSModelUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const STTModelUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const InterruptionModelUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const ModelUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionUsage",
  () => [
    { no: 1, name: "model_usage", kind: "message", T: ModelUsage, repeated: true }
  ]
);
const AgentSessionEvent = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionEvent",
  () => [
    { no: 1, name: "created_at", kind: "message", T: protobuf.Timestamp },
    ...
    { no: 18, name: "amd_prediction", kind: "message", T: AgentSessionEvent_AmdPrediction, oneof: "event" }
  ]
);
const AgentSessionEvent_AgentStateChanged = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionEvent.AgentStateChanged",
  () => [
    { no: 1, name: "old_state", kind: "enum", T: protobuf.proto3.getEnumType(AgentState) },
    { no: 2, name: "new_state", kind: "enum", T: protobuf.proto3.getEnumType(AgentState) }
  ],
  { localName: "AgentSessionEvent_AgentStateChanged" }
);
const AgentSessionEvent_UserStateChanged = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionEvent.UserStateChanged",
  () => [
    { no: 1, name: "old_state", kind: "enum", T: protobuf.proto3.getEnumType(UserState) },
    { no: 2, name: "new_state", kind: "enum", T: protobuf.proto3.getEnumType(UserState) }
  ],
  { localName: "AgentSessionEvent_UserStateChanged" }
);
const AgentSessionEvent_ConversationItemAdded = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionEvent_UserInputTranscribed = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionEvent_FunctionToolsExecuted = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionEvent_Error = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionEvent_OverlappingSpeech = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "overlap_started_at", kind: "message", T: protobuf.Timestamp, opt: true },
    {
      no: 3,
    ...
    { no: 4, name: "detected_at", kind: "message", T: protobuf.Timestamp }
  ],
  { localName: "AgentSessionEvent_OverlappingSpeech" }
);
const AgentSessionEvent_AmdPrediction = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionEvent.AmdPrediction",
  () => [
    { no: 1, name: "speech_duration", kind: "message", T: protobuf.Duration },
    { no: 2, name: "category", kind: "enum", T: protobuf.proto3.getEnumType(AmdCategory) },
    {
      no: 3,
      name: "reason",
      kind: "scalar",
    ...
    { no: 5, name: "delay", kind: "message", T: protobuf.Duration }
  ],
  { localName: "AgentSessionEvent_AmdPrediction" }
);
const AgentSessionEvent_SessionUsageUpdated = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const SessionRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 10, name: "get_framework_info", kind: "message", T: SessionRequest_GetFrameworkInfo, oneof: "request" }
  ]
);
const SessionRequest_Ping = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.Ping",
  [],
  { localName: "SessionRequest_Ping" }
);
const SessionRequest_GetChatHistory = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetChatHistory",
  [],
  { localName: "SessionRequest_GetChatHistory" }
);
const SessionRequest_RunInput = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const SessionRequest_GetAgentInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetAgentInfo",
  [],
  { localName: "SessionRequest_GetAgentInfo" }
);
const SessionRequest_GetSessionState = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetSessionState",
  [],
  { localName: "SessionRequest_GetSessionState" }
);
const SessionRequest_GetRTCStats = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetRTCStats",
  [],
  { localName: "SessionRequest_GetRTCStats" }
);
const SessionRequest_GetSessionUsage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetSessionUsage",
  [],
  { localName: "SessionRequest_GetSessionUsage" }
);
const SessionRequest_GetFrameworkInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionRequest.GetFrameworkInfo",
  [],
  { localName: "SessionRequest_GetFrameworkInfo" }
);
const SessionResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 11, name: "get_framework_info", kind: "message", T: SessionResponse_GetFrameworkInfoResponse, oneof: "response" }
  ]
);
const SessionResponse_Pong = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionResponse.Pong",
  [],
  { localName: "SessionResponse_Pong" }
);
const SessionResponse_GetChatHistoryResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const SessionResponse_GetAgentInfoResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const SessionResponse_RunInputResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const SessionResponse_GetSessionStateResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionResponse.GetSessionStateResponse",
  () => [
    { no: 1, name: "agent_state", kind: "enum", T: protobuf.proto3.getEnumType(AgentState) },
    { no: 2, name: "user_state", kind: "enum", T: protobuf.proto3.getEnumType(UserState) },
    {
      no: 3,
      name: "agent_id",
      kind: "scalar",
...
const SessionResponse_GetRTCStatsResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionResponse.GetRTCStatsResponse",
  () => [
    { no: 1, name: "publisher_stats", kind: "message", T: protobuf.Struct, repeated: true },
    { no: 2, name: "subscriber_stats", kind: "message", T: protobuf.Struct, repeated: true }
  ],
  { localName: "SessionResponse_GetRTCStatsResponse" }
);
const SessionResponse_GetSessionUsageResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.SessionResponse.GetSessionUsageResponse",
  () => [
    { no: 1, name: "usage", kind: "message", T: AgentSessionUsage },
    { no: 2, name: "created_at", kind: "message", T: protobuf.Timestamp }
  ],
  { localName: "SessionResponse_GetSessionUsageResponse" }
);
const SessionResponse_GetFrameworkInfoResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionMessage = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionMessage_ConsoleIO = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionMessage.ConsoleIO",
  [],
  { localName: "AgentSessionMessage_ConsoleIO" }
);
const AgentSessionMessage_ConsoleIO_AudioFrame = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AgentSessionMessage_ConsoleIO_AudioPlaybackFlush = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush",
  [],
  { localName: "AgentSessionMessage_ConsoleIO_AudioPlaybackFlush" }
);
const AgentSessionMessage_ConsoleIO_AudioPlaybackClear = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear",
  [],
  { localName: "AgentSessionMessage_ConsoleIO_AudioPlaybackClear" }
);
const AgentSessionMessage_ConsoleIO_AudioPlaybackFinished = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const livekit_agent_session_pb = {
  __proto__: null,
  AgentConfigUpdate: AgentConfigUpdate,
  AgentHandoff: AgentHandoff,
  AgentSessionEvent: AgentSessionEvent,
  AgentSessionEvent_AgentStateChanged: AgentSessionEvent_AgentStateChanged,
  AgentSessionEvent_AmdPrediction: AgentSessionEvent_AmdPrediction,
  AgentSessionEvent_ConversationItemAdded: AgentSessionEvent_ConversationItemAdded,
  AgentSessionEvent_Error: AgentSessionEvent_Error,
  AgentSessionEvent_FunctionToolsExecuted: AgentSessionEvent_FunctionToolsExecuted,
  AgentSessionEvent_OverlappingSpeech: AgentSessionEvent_OverlappingSpeech,
  AgentSessionEvent_SessionUsageUpdated: AgentSessionEvent_SessionUsageUpdated,
  AgentSessionEvent_UserInputTranscribed: AgentSessionEvent_UserInputTranscribed,
  AgentSessionEvent_UserStateChanged: AgentSessionEvent_UserStateChanged,
  AgentSessionMessage: AgentSessionMessage,
  AgentSessionMessage_ConsoleIO: AgentSessionMessage_ConsoleIO,
  AgentSessionMessage_ConsoleIO_AudioFrame: AgentSessionMessage_ConsoleIO_AudioFrame,
  AgentSessionMessage_ConsoleIO_AudioPlaybackClear: AgentSessionMessage_ConsoleIO_AudioPlaybackClear,
  AgentSessionMessage_ConsoleIO_AudioPlaybackFinished: AgentSessionMessage_ConsoleIO_AudioPlaybackFinished,
  AgentSessionMessage_ConsoleIO_AudioPlaybackFlush: AgentSessionMessage_ConsoleIO_AudioPlaybackFlush,
  AgentSessionUsage: AgentSessionUsage,
  AgentState: AgentState,
  AmdCategory: AmdCategory,
  ChatContext: ChatContext,
  ChatContext_ChatItem: ChatContext_ChatItem,
  ChatMessage: ChatMessage$1,
  ChatMessage_ChatContent: ChatMessage_ChatContent,
  ChatRole: ChatRole,
  FunctionCall: FunctionCall,
  FunctionCallOutput: FunctionCallOutput,
  InterruptionModelUsage: InterruptionModelUsage,
  LLMModelUsage: LLMModelUsage,
  MetricsReport: MetricsReport,
  ModelUsage: ModelUsage,
  STTModelUsage: STTModelUsage,
  SessionRequest: SessionRequest,
  SessionRequest_GetAgentInfo: SessionRequest_GetAgentInfo,
  SessionRequest_GetChatHistory: SessionRequest_GetChatHistory,
  SessionRequest_GetFrameworkInfo: SessionRequest_GetFrameworkInfo,
  SessionRequest_GetRTCStats: SessionRequest_GetRTCStats,
  SessionRequest_GetSessionState: SessionRequest_GetSessionState,
  SessionRequest_GetSessionUsage: SessionRequest_GetSessionUsage,
  SessionRequest_Ping: SessionRequest_Ping,
  SessionRequest_RunInput: SessionRequest_RunInput,
  SessionResponse: SessionResponse,
  SessionResponse_GetAgentInfoResponse: SessionResponse_GetAgentInfoResponse,
  SessionResponse_GetChatHistoryResponse: SessionResponse_GetChatHistoryResponse,
  SessionResponse_GetFrameworkInfoResponse: SessionResponse_GetFrameworkInfoResponse,
  SessionResponse_GetRTCStatsResponse: SessionResponse_GetRTCStatsResponse,
  SessionResponse_GetSessionStateResponse: SessionResponse_GetSessionStateResponse,
  SessionResponse_GetSessionUsageResponse: SessionResponse_GetSessionUsageResponse,
  SessionResponse_Pong: SessionResponse_Pong,
  SessionResponse_RunInputResponse: SessionResponse_RunInputResponse,
  TTSModelUsage: TTSModelUsage,
...
const MetricsRecordingHeader = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "start_time", kind: "message", T: protobuf.Timestamp },
    ...
    { no: 7, name: "room_start_time", kind: "message", T: protobuf.Timestamp }
  ]
);
...
const DataTrackExtensionID = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const PacketTrailerFeature = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const TrackInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 21, name: "packet_trailer_features", kind: "enum", T: protobuf.proto3.getEnumType(PacketTrailerFeature), repeated: true }
  ]
);
const DataTrackInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "encryption", kind: "enum", T: protobuf.proto3.getEnumType(Encryption_Type) }
  ]
);
const DataTrackExtensionParticipantSid = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.DataTrackExtensionParticipantSid",
  () => [
    { no: 1, name: "id", kind: "enum", T: protobuf.proto3.getEnumType(DataTrackExtensionID) },
    {
      no: 2,
...
const DataTrackSubscriptionOptions = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const ClientInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 13, name: "capabilities", kind: "enum", T: protobuf.proto3.getEnumType(ClientInfo_Capability), repeated: true }
  ]
);
...
const ClientInfo_Capability = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const JobRestartPolicy = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const CreateAgentDispatchRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "restart_policy", kind: "enum", T: protobuf.proto3.getEnumType(JobRestartPolicy) },
    {
      no: 5,
      name: "deployment",
      kind: "scalar",
...
const RoomAgentDispatch = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "restart_policy", kind: "enum", T: protobuf.proto3.getEnumType(JobRestartPolicy) },
    {
      no: 4,
      name: "deployment",
      kind: "scalar",
...
const AgentDispatch = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "restart_policy", kind: "enum", T: protobuf.proto3.getEnumType(JobRestartPolicy) },
    {
      no: 7,
      name: "deployment",
      kind: "scalar",
...
const AudioChannel = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const StartEgressRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.StartEgressRequest",
  () => [
    {
      no: 1,
      name: "room_name",
    ...
    { no: 2, name: "template", kind: "message", T: TemplateSource, oneof: "source" },
    { no: 3, name: "web", kind: "message", T: WebSource, oneof: "source" },
    { no: 4, name: "media", kind: "message", T: MediaSource, oneof: "source" },
    { no: 5, name: "preset", kind: "enum", T: protobuf.proto3.getEnumType(EncodingOptionsPreset), oneof: "encoding" },
    { no: 6, name: "advanced", kind: "message", T: EncodingOptions, oneof: "encoding" },
    { no: 7, name: "outputs", kind: "message", T: Output, repeated: true },
    { no: 8, name: "storage", kind: "message", T: StorageConfig },
    { no: 9, name: "webhooks", kind: "message", T: WebhookConfig, repeated: true }
  ]
);
const TemplateSource = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const WebSource = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.WebSource",
  () => [
    {
      no: 1,
...
const MediaSource = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.MediaSource",
  () => [
...
const ParticipantVideo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AudioConfig = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.AudioConfig",
  () => [
    { no: 1, name: "routes", kind: "message", T: AudioRoute, repeated: true }
  ]
);
const AudioRoute = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.AudioRoute",
  () => [
    { no: 1, name: "track_id", kind: "scalar", T: 9, oneof: "match" },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9, oneof: "match" },
    { no: 3, name: "participant_kind", kind: "enum", T: protobuf.proto3.getEnumType(ParticipantInfo_Kind), oneof: "match" },
    { no: 4, name: "channel", kind: "enum", T: protobuf.proto3.getEnumType(AudioChannel) }
  ]
);
const DataConfig = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.DataConfig",
  () => [
    { no: 1, name: "selectors", kind: "message", T: DataSelector, repeated: true }
  ]
);
const DataSelector = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const Output = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.Output",
  () => [
...
const FileOutput = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.FileOutput",
  () => [
...
const StorageConfig = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const UpdateEgressRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.UpdateEgressRequest",
  () => [
    {
      no: 1,
      name: "egress_id",
    ...
    { no: 4, name: "add_stream_urls", kind: "scalar", T: 9, repeated: true },
    { no: 5, name: "remove_stream_urls", kind: "scalar", T: 9, repeated: true }
  ]
);
...
const ExportReplayRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "preset", kind: "enum", T: protobuf.proto3.getEnumType(EncodingOptionsPreset), oneof: "encoding" },
...
const SIPCodec = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.SIPCodec",
  () => [
    {
      no: 1,
...
const SIPMediaConfig = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "encryption", kind: "enum", T: protobuf.proto3.getEnumType(SIPMediaEncryption), opt: true }
  ]
);
...
const SIPInboundTrunkInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 17, name: "created_at", kind: "message", T: protobuf.Timestamp },
    { no: 18, name: "updated_at", kind: "message", T: protobuf.Timestamp }
  ]
);
...
const SIPOutboundTrunkInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 16, name: "created_at", kind: "message", T: protobuf.Timestamp },
    { no: 17, name: "updated_at", kind: "message", T: protobuf.Timestamp }
  ]
);
...
const SIPDispatchRuleInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 14, name: "created_at", kind: "message", T: protobuf.Timestamp },
    { no: 15, name: "updated_at", kind: "message", T: protobuf.Timestamp }
  ]
);
...
const Destination = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.Destination",
  () => [
    {
      no: 1,
...
const StreamType = /* @__PURE__ */ protobuf.proto3.makeEnum(
  "livekit.StreamType",
  [
    { no: 0, name: "UPSTREAM" },
...
const AnalyticsEventType = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const AnalyticsVideoLayer = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AnalyticsStream = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 17, name: "start_time", kind: "message", T: protobuf.Timestamp },
    { no: 18, name: "end_time", kind: "message", T: protobuf.Timestamp },
    {
      no: 19,
      name: "packets_out_of_order",
      kind: "scalar",
...
const AnalyticsStat = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "kind", kind: "enum", T: protobuf.proto3.getEnumType(StreamType) },
    { no: 3, name: "time_stamp", kind: "message", T: protobuf.Timestamp },
    {
      no: 4,
      name: "node",
      kind: "scalar",
...
const AnalyticsStats = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.AnalyticsStats",
  () => [
    { no: 1, name: "stats", kind: "message", T: AnalyticsStat, repeated: true }
  ]
);
const AnalyticsClientMeta = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 6, name: "reconnect_reason", kind: "enum", T: protobuf.proto3.getEnumType(ReconnectReason) },
...
const AnalyticsEvent = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 1, name: "type", kind: "enum", T: protobuf.proto3.getEnumType(AnalyticsEventType) },
    { no: 2, name: "timestamp", kind: "message", T: protobuf.Timestamp },
    {
      no: 3,
      name: "room_id",
      kind: "scalar",
    ...
    { no: 14, name: "max_subscribed_video_quality", kind: "enum", T: protobuf.proto3.getEnumType(VideoQuality) },
...
const AnalyticsEvents = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.AnalyticsEvents",
  () => [
    { no: 1, name: "events", kind: "message", T: AnalyticsEvent, repeated: true }
  ]
);
const AnalyticsRoomParticipant = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "state", kind: "enum", T: protobuf.proto3.getEnumType(ParticipantInfo_State) },
    { no: 5, name: "joined_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const AnalyticsRoom = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "created_at", kind: "message", T: protobuf.Timestamp },
    { no: 4, name: "participants", kind: "message", T: AnalyticsRoomParticipant, repeated: true }
  ]
);
const AnalyticsNodeRooms = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "timestamp", kind: "message", T: protobuf.Timestamp },
    { no: 4, name: "rooms", kind: "message", T: AnalyticsRoom, repeated: true }
  ]
);
const ReportInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.ReportInfo",
  () => [
    { no: 1, name: "feature_usage", kind: "message", T: FeatureUsageInfo, oneof: "message" }
  ]
);
const TimeRange = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.TimeRange",
  () => [
    { no: 1, name: "started_at", kind: "message", T: protobuf.Timestamp },
    { no: 2, name: "ended_at", kind: "message", T: protobuf.Timestamp }
  ]
);
const FeatureUsageInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.FeatureUsageInfo",
  () => [
    { no: 1, name: "feature", kind: "enum", T: protobuf.proto3.getEnumType(FeatureUsageInfo_Feature) },
    {
      no: 2,
      name: "project_id",
      kind: "scalar",
    ...
    { no: 9, name: "feature_info", kind: "map", K: 9, V: {
      kind: "scalar",
      T: 9
      /* ScalarType.STRING */
    } }
...
const FeatureUsageInfo_Feature = /* @__PURE__ */ protobuf.proto3.makeEnum(
  "livekit.FeatureUsageInfo.Feature",
  [
    { no: 0, name: "KRISP_NOISE_CANCELLATION" },
    { no: 1, name: "KRISP_BACKGROUND_VOICE_CANCELLATION" },
    { no: 2, name: "AIC_AUDIO_ENHANCEMENT" }
  ]
);
const APICallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const APICallInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.APICallInfo",
  () => [
    {
      no: 1,
    ...
    { no: 14, name: "started_at", kind: "message", T: protobuf.Timestamp },
    {
      no: 15,
      name: "duration_ns",
      kind: "scalar",
...
const WebhookInfo = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.WebhookInfo",
  () => [
    {
      no: 1,
    ...
    { no: 11, name: "created_at", kind: "message", T: protobuf.Timestamp },
    { no: 12, name: "queued_at", kind: "message", T: protobuf.Timestamp },
    {
      no: 13,
      name: "queue_duration_ns",
      kind: "scalar",
      T: 3
      /* ScalarType.INT64 */
    },
    { no: 14, name: "sent_at", kind: "message", T: protobuf.Timestamp },
    {
      no: 15,
...
const ConnectorType = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const ConnectTwilioCallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.ConnectTwilioCallRequest",
  () => [
    { no: 1, name: "twilio_call_direction", kind: "enum", T: protobuf.proto3.getEnumType(ConnectTwilioCallRequest_TwilioCallDirection) },
    {
      no: 2,
      name: "room_name",
      kind: "scalar",
...
const ConnectTwilioCallRequest_TwilioCallDirection = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const ConnectTwilioCallResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const AddTrackRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 18, name: "packet_trailer_features", kind: "enum", T: protobuf.proto3.getEnumType(PacketTrailerFeature), repeated: true }
  ]
);
const PublishDataTrackRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "encryption", kind: "enum", T: protobuf.proto3.getEnumType(Encryption_Type) }
  ]
);
const PublishDataTrackResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.PublishDataTrackResponse",
  () => [
    { no: 1, name: "info", kind: "message", T: DataTrackInfo }
  ]
);
const UnpublishDataTrackRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const UnpublishDataTrackResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.UnpublishDataTrackResponse",
  () => [
    { no: 1, name: "info", kind: "message", T: DataTrackInfo }
  ]
);
const DataTrackSubscriberHandles = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const DataTrackSubscriberHandles_PublishedDataTrack = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const UpdateDataSubscription = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.UpdateDataSubscription",
  () => [
    { no: 1, name: "updates", kind: "message", T: UpdateDataSubscription_Update, repeated: true }
  ]
);
const UpdateDataSubscription_Update = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const WhatsAppCallDirection = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const DialWhatsAppCallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 13, name: "ringing_timeout", kind: "message", T: protobuf.Duration }
  ]
);
const DialWhatsAppCallResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const DisconnectWhatsAppCallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 3, name: "disconnect_reason", kind: "enum", T: protobuf.proto3.getEnumType(DisconnectWhatsAppCallRequest_DisconnectReason) }
  ]
);
const DisconnectWhatsAppCallRequest_DisconnectReason = /* @__PURE__ */ protobuf.proto3.makeEnum(
...
const DisconnectWhatsAppCallResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.DisconnectWhatsAppCallResponse",
  []
);
const ConnectWhatsAppCallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const ConnectWhatsAppCallResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  "livekit.ConnectWhatsAppCallResponse",
  []
);
const AcceptWhatsAppCallRequest = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 14, name: "ringing_timeout", kind: "message", T: protobuf.Duration },
    {
      no: 15,
      name: "wait_until_answered",
      kind: "scalar",
...
const AcceptWhatsAppCallResponse = /* @__PURE__ */ protobuf.proto3.makeMessageType(
...
const WhatsAppCall = /* @__PURE__ */ protobuf.proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "direction", kind: "enum", T: protobuf.proto3.getEnumType(WhatsAppCallDirection) }
  ]
);
...
exports.Timestamp = protobuf.Timestamp;
exports.protoInt64 = protobuf.protoInt64;
exports.APICallInfo = APICallInfo;
exports.APICallRequest = APICallRequest;
exports.AcceptWhatsAppCallRequest = AcceptWhatsAppCallRequest;
exports.AcceptWhatsAppCallResponse = AcceptWhatsAppCallResponse;
...
exports.AgentSession = livekit_agent_session_pb;
exports.AliOSSUpload = AliOSSUpload;
exports.AnalyticsClientMeta = AnalyticsClientMeta;
exports.AnalyticsEvent = AnalyticsEvent;
exports.AnalyticsEventType = AnalyticsEventType;
exports.AnalyticsEvents = AnalyticsEvents;
exports.AnalyticsNodeRooms = AnalyticsNodeRooms;
exports.AnalyticsRoom = AnalyticsRoom;
exports.AnalyticsRoomParticipant = AnalyticsRoomParticipant;
exports.AnalyticsStat = AnalyticsStat;
exports.AnalyticsStats = AnalyticsStats;
exports.AnalyticsStream = AnalyticsStream;
exports.AnalyticsVideoLayer = AnalyticsVideoLayer;
...
exports.ClientInfo_Capability = ClientInfo_Capability;
exports.ClientInfo_SDK = ClientInfo_SDK;
exports.Codec = Codec;
exports.ConnectTwilioCallRequest = ConnectTwilioCallRequest;
exports.ConnectTwilioCallRequest_TwilioCallDirection = ConnectTwilioCallRequest_TwilioCallDirection;
exports.ConnectTwilioCallResponse = ConnectTwilioCallResponse;
exports.ConnectWhatsAppCallRequest = ConnectWhatsAppCallRequest;
exports.ConnectWhatsAppCallResponse = ConnectWhatsAppCallResponse;
...
exports.DataTrackExtensionID = DataTrackExtensionID;
exports.DataTrackExtensionParticipantSid = DataTrackExtensionParticipantSid;
exports.DataTrackInfo = DataTrackInfo;
exports.DataTrackSubscriberHandles = DataTrackSubscriberHandles;
exports.DataTrackSubscriberHandles_PublishedDataTrack = DataTrackSubscriberHandles_PublishedDataTrack;
exports.DataTrackSubscriptionOptions = DataTrackSubscriptionOptions;
...
exports.DialWhatsAppCallRequest = DialWhatsAppCallRequest;
exports.DialWhatsAppCallResponse = DialWhatsAppCallResponse;
exports.DirectFileOutput = DirectFileOutput;
exports.DisabledCodecs = DisabledCodecs;
exports.DisconnectReason = DisconnectReason;
exports.DisconnectWhatsAppCallRequest = DisconnectWhatsAppCallRequest;
exports.DisconnectWhatsAppCallRequest_DisconnectReason = DisconnectWhatsAppCallRequest_DisconnectReason;
exports.DisconnectWhatsAppCallResponse = DisconnectWhatsAppCallResponse;
...
exports.ExportReplayRequest = ExportReplayRequest;
exports.FeatureUsageInfo = FeatureUsageInfo;
exports.FeatureUsageInfo_Feature = FeatureUsageInfo_Feature;
...
exports.JobRestartPolicy = JobRestartPolicy;
...
exports.ParticipantVideo = ParticipantVideo;
...
exports.SIPMediaConfig = SIPMediaConfig;
...
exports.StartEgressRequest = StartEgressRequest;
...
exports.UnpublishDataTrackRequest = UnpublishDataTrackRequest;
exports.UnpublishDataTrackResponse = UnpublishDataTrackResponse;
exports.UpdateDataSubscription = UpdateDataSubscription;
exports.UpdateDataSubscription_Update = UpdateDataSubscription_Update;
exports.UpdateEgressRequest = UpdateEgressRequest;
...
exports.WhatsAppCall = WhatsAppCall;
exports.WhatsAppCallDirection = WhatsAppCallDirection;
