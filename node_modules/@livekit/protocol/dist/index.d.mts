import { Message, Timestamp, PartialMessage, proto3, FieldList, BinaryReadOptions, JsonValue, JsonReadOptions, PlainMessage, Duration, Struct, Any } from '@bufbuild/protobuf';
export { Timestamp, protoInt64 } from '@bufbuild/protobuf';
...
/**
 * @generated from enum livekit.agent.AgentState
 */
declare enum AgentState {
  /**
   * @generated from enum value: AS_INITIALIZING = 0;
   */
  AS_INITIALIZING = 0,

  /**
   * @generated from enum value: AS_IDLE = 1;
   */
  AS_IDLE = 1,

  /**
   * @generated from enum value: AS_LISTENING = 2;
   */
  AS_LISTENING = 2,

  /**
   * @generated from enum value: AS_THINKING = 3;
   */
  AS_THINKING = 3,

  /**
   * @generated from enum value: AS_SPEAKING = 4;
   */
  AS_SPEAKING = 4,
}

/**
 * @generated from enum livekit.agent.UserState
 */
declare enum UserState {
  /**
   * @generated from enum value: US_SPEAKING = 0;
   */
  US_SPEAKING = 0,

  /**
   * @generated from enum value: US_LISTENING = 1;
   */
  US_LISTENING = 1,

  /**
   * @generated from enum value: US_AWAY = 2;
   */
  US_AWAY = 2,
}

/**
 * @generated from enum livekit.agent.AmdCategory
 */
declare enum AmdCategory {
  /**
   * @generated from enum value: AMD_UNKNOWN = 0;
   */
  AMD_UNKNOWN = 0,

  /**
   * @generated from enum value: AMD_HUMAN = 1;
   */
  AMD_HUMAN = 1,

  /**
   * @generated from enum value: AMD_MACHINE_IVR = 2;
   */
  AMD_MACHINE_IVR = 2,

  /**
   * @generated from enum value: AMD_MACHINE_VM = 3;
   */
  AMD_MACHINE_VM = 3,

  /**
   * @generated from enum value: AMD_MACHINE_UNAVAILABLE = 4;
   */
  AMD_MACHINE_UNAVAILABLE = 4,

  /**
   * @generated from enum value: AMD_UNCERTAIN = 5;
   */
  AMD_UNCERTAIN = 5,
}
...
/**
 * @generated from message livekit.agent.TimedString
 */
declare class TimedString extends Message<TimedString> {
  /**
  ...
  /**
   * @generated from field: optional double end_time = 3;
   */
  endTime?: number;
  ...
  /**
   * @generated from field: optional double start_time_offset = 5;
   */
  startTimeOffset?: number;

  /**
   * @generated from field: optional string speaker_id = 6;
   */
  speakerId?: string;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.TimedString";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.agent.AgentConfigUpdate
 */
declare class AgentConfigUpdate extends Message<AgentConfigUpdate> {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
  ...
  /**
   * @generated from field: repeated string tools_added = 3;
   */
  toolsAdded: string[];

  /**
   * @generated from field: repeated string tools_removed = 4;
   */
  toolsRemoved: string[];
  ...
  constructor(data?: PartialMessage<AgentConfigUpdate>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentConfigUpdate";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentConfigUpdate;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentConfigUpdate;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentConfigUpdate;

  static equals(a: AgentConfigUpdate | PlainMessage<AgentConfigUpdate> | undefined, b: AgentConfigUpdate | PlainMessage<AgentConfigUpdate> | undefined): boolean;
}
...
declare class ChatContext_ChatItem extends Message<ChatContext_ChatItem> {
  ...
  item: {
    ...
    /**
     * @generated from field: livekit.agent.AgentConfigUpdate agent_config_update = 5;
     */
...
/**
 * @generated from message livekit.agent.LLMModelUsage
 */
declare class LLMModelUsage extends Message<LLMModelUsage> {
  /**
  ...
  /**
   * @generated from field: int32 input_cached_tokens = 4;
   */
  inputCachedTokens: number;

  /**
   * @generated from field: int32 input_audio_tokens = 5;
   */
  inputAudioTokens: number;

  /**
   * @generated from field: int32 input_cached_audio_tokens = 6;
   */
  inputCachedAudioTokens: number;

  /**
   * @generated from field: int32 input_text_tokens = 7;
   */
  inputTextTokens: number;

  /**
   * @generated from field: int32 input_cached_text_tokens = 8;
   */
  inputCachedTextTokens: number;

  /**
   * @generated from field: int32 input_image_tokens = 9;
   */
  inputImageTokens: number;

  /**
   * @generated from field: int32 input_cached_image_tokens = 10;
   */
  ...
  /**
   * @generated from field: int32 output_audio_tokens = 12;
   */
  outputAudioTokens: number;

  /**
   * @generated from field: int32 output_text_tokens = 13;
   */
  outputTextTokens: number;

  /**
   * @generated from field: double session_duration = 14;
   */
  sessionDuration: number;

  constructor(data?: PartialMessage<LLMModelUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.LLMModelUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): LLMModelUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): LLMModelUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): LLMModelUsage;

  static equals(a: LLMModelUsage | PlainMessage<LLMModelUsage> | undefined, b: LLMModelUsage | PlainMessage<LLMModelUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.TTSModelUsage
 */
declare class TTSModelUsage extends Message<TTSModelUsage> {
  /**
   * @generated from field: string provider = 1;
   */
  provider: string;
  ...
  /**
   * @generated from field: int32 characters_count = 5;
   */
  charactersCount: number;

  /**
   * @generated from field: double audio_duration = 6;
   */
  audioDuration: number;

  constructor(data?: PartialMessage<TTSModelUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.TTSModelUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TTSModelUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TTSModelUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TTSModelUsage;

  static equals(a: TTSModelUsage | PlainMessage<TTSModelUsage> | undefined, b: TTSModelUsage | PlainMessage<TTSModelUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.STTModelUsage
 */
declare class STTModelUsage extends Message<STTModelUsage> {
  /**
   * @generated from field: string provider = 1;
   */
  provider: string;
  ...
  /**
   * @generated from field: double audio_duration = 5;
   */
  audioDuration: number;

  constructor(data?: PartialMessage<STTModelUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.STTModelUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): STTModelUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): STTModelUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): STTModelUsage;

  static equals(a: STTModelUsage | PlainMessage<STTModelUsage> | undefined, b: STTModelUsage | PlainMessage<STTModelUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.InterruptionModelUsage
 */
declare class InterruptionModelUsage extends Message<InterruptionModelUsage> {
  /**
   * @generated from field: string provider = 1;
   */
  provider: string;
  ...
  constructor(data?: PartialMessage<InterruptionModelUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.InterruptionModelUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): InterruptionModelUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): InterruptionModelUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): InterruptionModelUsage;

  static equals(a: InterruptionModelUsage | PlainMessage<InterruptionModelUsage> | undefined, b: InterruptionModelUsage | PlainMessage<InterruptionModelUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.ModelUsage
 */
declare class ModelUsage extends Message<ModelUsage> {
  /**
   * @generated from oneof livekit.agent.ModelUsage.usage
   */
  usage: {
    /**
     * @generated from field: livekit.agent.LLMModelUsage llm = 1;
     */
    value: LLMModelUsage;
    case: "llm";
  } | {
    /**
     * @generated from field: livekit.agent.TTSModelUsage tts = 2;
     */
    value: TTSModelUsage;
    case: "tts";
  } | {
    /**
     * @generated from field: livekit.agent.STTModelUsage stt = 3;
     */
    value: STTModelUsage;
    case: "stt";
  } | {
    /**
     * @generated from field: livekit.agent.InterruptionModelUsage interruption = 4;
     */
    value: InterruptionModelUsage;
    case: "interruption";
  } | { case: undefined; value?: undefined };
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.ModelUsage";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.agent.AgentSessionUsage
 */
declare class AgentSessionUsage extends Message<AgentSessionUsage> {
  /**
   * @generated from field: repeated livekit.agent.ModelUsage model_usage = 1;
   */
  modelUsage: ModelUsage[];

  constructor(data?: PartialMessage<AgentSessionUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionUsage;

  static equals(a: AgentSessionUsage | PlainMessage<AgentSessionUsage> | undefined, b: AgentSessionUsage | PlainMessage<AgentSessionUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent
 */
declare class AgentSessionEvent extends Message<AgentSessionEvent> {
  /**
  ...
  /**
   * @generated from oneof livekit.agent.AgentSessionEvent.event
   */
  event: {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.AgentStateChanged agent_state_changed = 10;
     */
    value: AgentSessionEvent_AgentStateChanged;
    case: "agentStateChanged";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.UserStateChanged user_state_changed = 11;
     */
    value: AgentSessionEvent_UserStateChanged;
    case: "userStateChanged";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.ConversationItemAdded conversation_item_added = 12;
     */
    value: AgentSessionEvent_ConversationItemAdded;
    case: "conversationItemAdded";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.UserInputTranscribed user_input_transcribed = 13;
     */
    value: AgentSessionEvent_UserInputTranscribed;
    case: "userInputTranscribed";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.FunctionToolsExecuted function_tools_executed = 14;
     */
    value: AgentSessionEvent_FunctionToolsExecuted;
    case: "functionToolsExecuted";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.Error error = 15;
     */
    value: AgentSessionEvent_Error;
    case: "error";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.OverlappingSpeech overlapping_speech = 16;
     */
    value: AgentSessionEvent_OverlappingSpeech;
    case: "overlappingSpeech";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.SessionUsageUpdated session_usage_updated = 17;
     */
    value: AgentSessionEvent_SessionUsageUpdated;
    case: "sessionUsageUpdated";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent.AmdPrediction amd_prediction = 18;
     */
    value: AgentSessionEvent_AmdPrediction;
    case: "amdPrediction";
  } | { case: undefined; value?: undefined };
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.agent.AgentSessionEvent.AgentStateChanged
 */
declare class AgentSessionEvent_AgentStateChanged extends Message<AgentSessionEvent_AgentStateChanged> {
  /**
   * @generated from field: livekit.agent.AgentState old_state = 1;
   */
  oldState: AgentState;

  /**
   * @generated from field: livekit.agent.AgentState new_state = 2;
   */
  newState: AgentState;

  constructor(data?: PartialMessage<AgentSessionEvent_AgentStateChanged>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.AgentStateChanged";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_AgentStateChanged;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_AgentStateChanged;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_AgentStateChanged;

  static equals(a: AgentSessionEvent_AgentStateChanged | PlainMessage<AgentSessionEvent_AgentStateChanged> | undefined, b: AgentSessionEvent_AgentStateChanged | PlainMessage<AgentSessionEvent_AgentStateChanged> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.UserStateChanged
 */
declare class AgentSessionEvent_UserStateChanged extends Message<AgentSessionEvent_UserStateChanged> {
  /**
   * @generated from field: livekit.agent.UserState old_state = 1;
   */
  oldState: UserState;

  /**
   * @generated from field: livekit.agent.UserState new_state = 2;
   */
  newState: UserState;

  constructor(data?: PartialMessage<AgentSessionEvent_UserStateChanged>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.UserStateChanged";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_UserStateChanged;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_UserStateChanged;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_UserStateChanged;

  static equals(a: AgentSessionEvent_UserStateChanged | PlainMessage<AgentSessionEvent_UserStateChanged> | undefined, b: AgentSessionEvent_UserStateChanged | PlainMessage<AgentSessionEvent_UserStateChanged> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.ConversationItemAdded
 */
declare class AgentSessionEvent_ConversationItemAdded extends Message<AgentSessionEvent_ConversationItemAdded> {
  /**
   * @generated from field: livekit.agent.ChatContext.ChatItem item = 1;
   */
  item?: ChatContext_ChatItem;

  constructor(data?: PartialMessage<AgentSessionEvent_ConversationItemAdded>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.ConversationItemAdded";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_ConversationItemAdded;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_ConversationItemAdded;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_ConversationItemAdded;

  static equals(a: AgentSessionEvent_ConversationItemAdded | PlainMessage<AgentSessionEvent_ConversationItemAdded> | undefined, b: AgentSessionEvent_ConversationItemAdded | PlainMessage<AgentSessionEvent_ConversationItemAdded> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.UserInputTranscribed
 */
declare class AgentSessionEvent_UserInputTranscribed extends Message<AgentSessionEvent_UserInputTranscribed> {
  /**
  ...
  constructor(data?: PartialMessage<AgentSessionEvent_UserInputTranscribed>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.UserInputTranscribed";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_UserInputTranscribed;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_UserInputTranscribed;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_UserInputTranscribed;

  static equals(a: AgentSessionEvent_UserInputTranscribed | PlainMessage<AgentSessionEvent_UserInputTranscribed> | undefined, b: AgentSessionEvent_UserInputTranscribed | PlainMessage<AgentSessionEvent_UserInputTranscribed> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.FunctionToolsExecuted
 */
declare class AgentSessionEvent_FunctionToolsExecuted extends Message<AgentSessionEvent_FunctionToolsExecuted> {
  /**
   * @generated from field: repeated livekit.agent.FunctionCall function_calls = 1;
   */
  functionCalls: FunctionCall[];

  /**
   * @generated from field: repeated livekit.agent.FunctionCallOutput function_call_outputs = 2;
   */
  functionCallOutputs: FunctionCallOutput[];

  constructor(data?: PartialMessage<AgentSessionEvent_FunctionToolsExecuted>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.FunctionToolsExecuted";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_FunctionToolsExecuted;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_FunctionToolsExecuted;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_FunctionToolsExecuted;

  static equals(a: AgentSessionEvent_FunctionToolsExecuted | PlainMessage<AgentSessionEvent_FunctionToolsExecuted> | undefined, b: AgentSessionEvent_FunctionToolsExecuted | PlainMessage<AgentSessionEvent_FunctionToolsExecuted> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.Error
 */
declare class AgentSessionEvent_Error extends Message<AgentSessionEvent_Error> {
  /**
   * @generated from field: string message = 1;
   */
  message: string;

  constructor(data?: PartialMessage<AgentSessionEvent_Error>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.Error";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_Error;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_Error;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_Error;

  static equals(a: AgentSessionEvent_Error | PlainMessage<AgentSessionEvent_Error> | undefined, b: AgentSessionEvent_Error | PlainMessage<AgentSessionEvent_Error> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.OverlappingSpeech
 */
declare class AgentSessionEvent_OverlappingSpeech extends Message<AgentSessionEvent_OverlappingSpeech> {
  /**
   * @generated from field: bool is_interruption = 1;
   */
  isInterruption: boolean;

  /**
   * @generated from field: optional google.protobuf.Timestamp overlap_started_at = 2;
   */
  overlapStartedAt?: Timestamp;

  /**
   * @generated from field: double detection_delay = 3;
   */
  ...
  constructor(data?: PartialMessage<AgentSessionEvent_OverlappingSpeech>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.OverlappingSpeech";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_OverlappingSpeech;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_OverlappingSpeech;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_OverlappingSpeech;

  static equals(a: AgentSessionEvent_OverlappingSpeech | PlainMessage<AgentSessionEvent_OverlappingSpeech> | undefined, b: AgentSessionEvent_OverlappingSpeech | PlainMessage<AgentSessionEvent_OverlappingSpeech> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.AmdPrediction
 */
declare class AgentSessionEvent_AmdPrediction extends Message<AgentSessionEvent_AmdPrediction> {
  /**
   * @generated from field: google.protobuf.Duration speech_duration = 1;
   */
  speechDuration?: Duration;

  /**
   * @generated from field: livekit.agent.AmdCategory category = 2;
   */
  ...
  /**
   * @generated from field: string transcript = 4;
   */
  transcript: string;
  ...
  constructor(data?: PartialMessage<AgentSessionEvent_AmdPrediction>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.AmdPrediction";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_AmdPrediction;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_AmdPrediction;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_AmdPrediction;

  static equals(a: AgentSessionEvent_AmdPrediction | PlainMessage<AgentSessionEvent_AmdPrediction> | undefined, b: AgentSessionEvent_AmdPrediction | PlainMessage<AgentSessionEvent_AmdPrediction> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionEvent.SessionUsageUpdated
 */
declare class AgentSessionEvent_SessionUsageUpdated extends Message<AgentSessionEvent_SessionUsageUpdated> {
  /**
   * @generated from field: livekit.agent.AgentSessionUsage usage = 1;
   */
  usage?: AgentSessionUsage;

  constructor(data?: PartialMessage<AgentSessionEvent_SessionUsageUpdated>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionEvent.SessionUsageUpdated";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionEvent_SessionUsageUpdated;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionEvent_SessionUsageUpdated;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionEvent_SessionUsageUpdated;

  static equals(a: AgentSessionEvent_SessionUsageUpdated | PlainMessage<AgentSessionEvent_SessionUsageUpdated> | undefined, b: AgentSessionEvent_SessionUsageUpdated | PlainMessage<AgentSessionEvent_SessionUsageUpdated> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest
 */
declare class SessionRequest extends Message<SessionRequest> {
  /**
  ...
  /**
   * @generated from oneof livekit.agent.SessionRequest.request
   */
  request: {
    /**
     * @generated from field: livekit.agent.SessionRequest.Ping ping = 2;
     */
    value: SessionRequest_Ping;
    case: "ping";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetChatHistory get_chat_history = 4;
     */
    value: SessionRequest_GetChatHistory;
    case: "getChatHistory";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.RunInput run_input = 5;
     */
    value: SessionRequest_RunInput;
    case: "runInput";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetAgentInfo get_agent_info = 6;
     */
    value: SessionRequest_GetAgentInfo;
    case: "getAgentInfo";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetSessionState get_session_state = 7;
     */
    value: SessionRequest_GetSessionState;
    case: "getSessionState";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetRTCStats get_rtc_stats = 8;
     */
    value: SessionRequest_GetRTCStats;
    case: "getRtcStats";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetSessionUsage get_session_usage = 9;
     */
    value: SessionRequest_GetSessionUsage;
    case: "getSessionUsage";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest.GetFrameworkInfo get_framework_info = 10;
     */
    value: SessionRequest_GetFrameworkInfo;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.agent.SessionRequest.Ping
 */
declare class SessionRequest_Ping extends Message<SessionRequest_Ping> {
  constructor(data?: PartialMessage<SessionRequest_Ping>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.Ping";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_Ping;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_Ping;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_Ping;

  static equals(a: SessionRequest_Ping | PlainMessage<SessionRequest_Ping> | undefined, b: SessionRequest_Ping | PlainMessage<SessionRequest_Ping> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetChatHistory
 */
declare class SessionRequest_GetChatHistory extends Message<SessionRequest_GetChatHistory> {
  constructor(data?: PartialMessage<SessionRequest_GetChatHistory>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetChatHistory";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetChatHistory;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetChatHistory;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetChatHistory;

  static equals(a: SessionRequest_GetChatHistory | PlainMessage<SessionRequest_GetChatHistory> | undefined, b: SessionRequest_GetChatHistory | PlainMessage<SessionRequest_GetChatHistory> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.RunInput
 */
declare class SessionRequest_RunInput extends Message<SessionRequest_RunInput> {
  /**
   * @generated from field: string text = 1;
   */
  text: string;

  constructor(data?: PartialMessage<SessionRequest_RunInput>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.RunInput";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_RunInput;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_RunInput;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_RunInput;

  static equals(a: SessionRequest_RunInput | PlainMessage<SessionRequest_RunInput> | undefined, b: SessionRequest_RunInput | PlainMessage<SessionRequest_RunInput> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetAgentInfo
 */
declare class SessionRequest_GetAgentInfo extends Message<SessionRequest_GetAgentInfo> {
  constructor(data?: PartialMessage<SessionRequest_GetAgentInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetAgentInfo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetAgentInfo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetAgentInfo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetAgentInfo;

  static equals(a: SessionRequest_GetAgentInfo | PlainMessage<SessionRequest_GetAgentInfo> | undefined, b: SessionRequest_GetAgentInfo | PlainMessage<SessionRequest_GetAgentInfo> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetSessionState
 */
declare class SessionRequest_GetSessionState extends Message<SessionRequest_GetSessionState> {
  constructor(data?: PartialMessage<SessionRequest_GetSessionState>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetSessionState";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetSessionState;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetSessionState;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetSessionState;

  static equals(a: SessionRequest_GetSessionState | PlainMessage<SessionRequest_GetSessionState> | undefined, b: SessionRequest_GetSessionState | PlainMessage<SessionRequest_GetSessionState> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetRTCStats
 */
declare class SessionRequest_GetRTCStats extends Message<SessionRequest_GetRTCStats> {
  constructor(data?: PartialMessage<SessionRequest_GetRTCStats>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetRTCStats";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetRTCStats;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetRTCStats;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetRTCStats;

  static equals(a: SessionRequest_GetRTCStats | PlainMessage<SessionRequest_GetRTCStats> | undefined, b: SessionRequest_GetRTCStats | PlainMessage<SessionRequest_GetRTCStats> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetSessionUsage
 */
declare class SessionRequest_GetSessionUsage extends Message<SessionRequest_GetSessionUsage> {
  constructor(data?: PartialMessage<SessionRequest_GetSessionUsage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetSessionUsage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetSessionUsage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetSessionUsage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetSessionUsage;

  static equals(a: SessionRequest_GetSessionUsage | PlainMessage<SessionRequest_GetSessionUsage> | undefined, b: SessionRequest_GetSessionUsage | PlainMessage<SessionRequest_GetSessionUsage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionRequest.GetFrameworkInfo
 */
declare class SessionRequest_GetFrameworkInfo extends Message<SessionRequest_GetFrameworkInfo> {
  constructor(data?: PartialMessage<SessionRequest_GetFrameworkInfo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionRequest.GetFrameworkInfo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionRequest_GetFrameworkInfo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionRequest_GetFrameworkInfo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionRequest_GetFrameworkInfo;

  static equals(a: SessionRequest_GetFrameworkInfo | PlainMessage<SessionRequest_GetFrameworkInfo> | undefined, b: SessionRequest_GetFrameworkInfo | PlainMessage<SessionRequest_GetFrameworkInfo> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse
 */
declare class SessionResponse extends Message<SessionResponse> {
  /**
   * @generated from field: string request_id = 1;
   */
  requestId: string;
  ...
  /**
   * @generated from oneof livekit.agent.SessionResponse.response
   */
  response: {
    /**
     * @generated from field: livekit.agent.SessionResponse.Pong pong = 3;
     */
    value: SessionResponse_Pong;
    case: "pong";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetChatHistoryResponse get_chat_history = 5;
     */
    value: SessionResponse_GetChatHistoryResponse;
    case: "getChatHistory";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.RunInputResponse run_input = 6;
     */
    value: SessionResponse_RunInputResponse;
    case: "runInput";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetAgentInfoResponse get_agent_info = 7;
     */
    value: SessionResponse_GetAgentInfoResponse;
    case: "getAgentInfo";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetSessionStateResponse get_session_state = 8;
     */
    value: SessionResponse_GetSessionStateResponse;
    case: "getSessionState";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetRTCStatsResponse get_rtc_stats = 9;
     */
    value: SessionResponse_GetRTCStatsResponse;
    case: "getRtcStats";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetSessionUsageResponse get_session_usage = 10;
     */
    value: SessionResponse_GetSessionUsageResponse;
    case: "getSessionUsage";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse.GetFrameworkInfoResponse get_framework_info = 11;
     */
    value: SessionResponse_GetFrameworkInfoResponse;
    case: "getFrameworkInfo";
  } | { case: undefined; value?: undefined };
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.agent.SessionResponse.Pong
 */
declare class SessionResponse_Pong extends Message<SessionResponse_Pong> {
  constructor(data?: PartialMessage<SessionResponse_Pong>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.Pong";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_Pong;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_Pong;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_Pong;

  static equals(a: SessionResponse_Pong | PlainMessage<SessionResponse_Pong> | undefined, b: SessionResponse_Pong | PlainMessage<SessionResponse_Pong> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetChatHistoryResponse
 */
declare class SessionResponse_GetChatHistoryResponse extends Message<SessionResponse_GetChatHistoryResponse> {
  /**
   * @generated from field: repeated livekit.agent.ChatContext.ChatItem items = 1;
   */
  items: ChatContext_ChatItem[];

  constructor(data?: PartialMessage<SessionResponse_GetChatHistoryResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetChatHistoryResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetChatHistoryResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetChatHistoryResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetChatHistoryResponse;

  static equals(a: SessionResponse_GetChatHistoryResponse | PlainMessage<SessionResponse_GetChatHistoryResponse> | undefined, b: SessionResponse_GetChatHistoryResponse | PlainMessage<SessionResponse_GetChatHistoryResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetAgentInfoResponse
 */
declare class SessionResponse_GetAgentInfoResponse extends Message<SessionResponse_GetAgentInfoResponse> {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
  ...
  /**
   * @generated from field: repeated livekit.agent.ChatContext.ChatItem chat_ctx = 4;
   */
  chatCtx: ChatContext_ChatItem[];

  constructor(data?: PartialMessage<SessionResponse_GetAgentInfoResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetAgentInfoResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetAgentInfoResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetAgentInfoResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetAgentInfoResponse;

  static equals(a: SessionResponse_GetAgentInfoResponse | PlainMessage<SessionResponse_GetAgentInfoResponse> | undefined, b: SessionResponse_GetAgentInfoResponse | PlainMessage<SessionResponse_GetAgentInfoResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.RunInputResponse
 */
declare class SessionResponse_RunInputResponse extends Message<SessionResponse_RunInputResponse> {
  /**
   * @generated from field: repeated livekit.agent.ChatContext.ChatItem items = 1;
   */
  items: ChatContext_ChatItem[];

  constructor(data?: PartialMessage<SessionResponse_RunInputResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.RunInputResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_RunInputResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_RunInputResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_RunInputResponse;

  static equals(a: SessionResponse_RunInputResponse | PlainMessage<SessionResponse_RunInputResponse> | undefined, b: SessionResponse_RunInputResponse | PlainMessage<SessionResponse_RunInputResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetSessionStateResponse
 */
declare class SessionResponse_GetSessionStateResponse extends Message<SessionResponse_GetSessionStateResponse> {
  /**
   * @generated from field: livekit.agent.AgentState agent_state = 1;
   */
  agentState: AgentState;

  /**
   * @generated from field: livekit.agent.UserState user_state = 2;
   */
  userState: UserState;
  ...
  constructor(data?: PartialMessage<SessionResponse_GetSessionStateResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetSessionStateResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetSessionStateResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetSessionStateResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetSessionStateResponse;

  static equals(a: SessionResponse_GetSessionStateResponse | PlainMessage<SessionResponse_GetSessionStateResponse> | undefined, b: SessionResponse_GetSessionStateResponse | PlainMessage<SessionResponse_GetSessionStateResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetRTCStatsResponse
 */
declare class SessionResponse_GetRTCStatsResponse extends Message<SessionResponse_GetRTCStatsResponse> {
  /**
   * @generated from field: repeated google.protobuf.Struct publisher_stats = 1;
   */
  publisherStats: Struct[];

  /**
   * @generated from field: repeated google.protobuf.Struct subscriber_stats = 2;
   */
  subscriberStats: Struct[];

  constructor(data?: PartialMessage<SessionResponse_GetRTCStatsResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetRTCStatsResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetRTCStatsResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetRTCStatsResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetRTCStatsResponse;

  static equals(a: SessionResponse_GetRTCStatsResponse | PlainMessage<SessionResponse_GetRTCStatsResponse> | undefined, b: SessionResponse_GetRTCStatsResponse | PlainMessage<SessionResponse_GetRTCStatsResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetSessionUsageResponse
 */
declare class SessionResponse_GetSessionUsageResponse extends Message<SessionResponse_GetSessionUsageResponse> {
  /**
   * @generated from field: livekit.agent.AgentSessionUsage usage = 1;
   */
  usage?: AgentSessionUsage;
  ...
  constructor(data?: PartialMessage<SessionResponse_GetSessionUsageResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetSessionUsageResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetSessionUsageResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetSessionUsageResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetSessionUsageResponse;

  static equals(a: SessionResponse_GetSessionUsageResponse | PlainMessage<SessionResponse_GetSessionUsageResponse> | undefined, b: SessionResponse_GetSessionUsageResponse | PlainMessage<SessionResponse_GetSessionUsageResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.SessionResponse.GetFrameworkInfoResponse
 */
declare class SessionResponse_GetFrameworkInfoResponse extends Message<SessionResponse_GetFrameworkInfoResponse> {
  /**
  ...
  constructor(data?: PartialMessage<SessionResponse_GetFrameworkInfoResponse>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.SessionResponse.GetFrameworkInfoResponse";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SessionResponse_GetFrameworkInfoResponse;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SessionResponse_GetFrameworkInfoResponse;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SessionResponse_GetFrameworkInfoResponse;

  static equals(a: SessionResponse_GetFrameworkInfoResponse | PlainMessage<SessionResponse_GetFrameworkInfoResponse> | undefined, b: SessionResponse_GetFrameworkInfoResponse | PlainMessage<SessionResponse_GetFrameworkInfoResponse> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage
 */
declare class AgentSessionMessage extends Message<AgentSessionMessage> {
  /**
   * @generated from oneof livekit.agent.AgentSessionMessage.message
   */
  message: {
    /**
     * @generated from field: livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame audio_input = 1;
     */
    value: AgentSessionMessage_ConsoleIO_AudioFrame;
    case: "audioInput";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame audio_output = 2;
     */
    value: AgentSessionMessage_ConsoleIO_AudioFrame;
    case: "audioOutput";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionEvent event = 3;
     */
    value: AgentSessionEvent;
    case: "event";
  } | {
    /**
     * @generated from field: livekit.agent.SessionRequest request = 4;
     */
    value: SessionRequest;
    case: "request";
  } | {
    /**
     * @generated from field: livekit.agent.SessionResponse response = 5;
     */
    value: SessionResponse;
    case: "response";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush audio_playback_flush = 6;
     */
    value: AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;
    case: "audioPlaybackFlush";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear audio_playback_clear = 7;
     */
    value: AgentSessionMessage_ConsoleIO_AudioPlaybackClear;
    case: "audioPlaybackClear";
  } | {
    /**
     * @generated from field: livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished audio_playback_finished = 8;
     */
    value: AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;
    case: "audioPlaybackFinished";
  } | { case: undefined; value?: undefined };

  constructor(data?: PartialMessage<AgentSessionMessage>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage;

  static equals(a: AgentSessionMessage | PlainMessage<AgentSessionMessage> | undefined, b: AgentSessionMessage | PlainMessage<AgentSessionMessage> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage.ConsoleIO
 */
declare class AgentSessionMessage_ConsoleIO extends Message<AgentSessionMessage_ConsoleIO> {
  constructor(data?: PartialMessage<AgentSessionMessage_ConsoleIO>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage.ConsoleIO";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage_ConsoleIO;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO;

  static equals(a: AgentSessionMessage_ConsoleIO | PlainMessage<AgentSessionMessage_ConsoleIO> | undefined, b: AgentSessionMessage_ConsoleIO | PlainMessage<AgentSessionMessage_ConsoleIO> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame
 */
declare class AgentSessionMessage_ConsoleIO_AudioFrame extends Message<AgentSessionMessage_ConsoleIO_AudioFrame> {
  /**
  ...
  constructor(data?: PartialMessage<AgentSessionMessage_ConsoleIO_AudioFrame>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage.ConsoleIO.AudioFrame";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage_ConsoleIO_AudioFrame;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioFrame;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioFrame;

  static equals(a: AgentSessionMessage_ConsoleIO_AudioFrame | PlainMessage<AgentSessionMessage_ConsoleIO_AudioFrame> | undefined, b: AgentSessionMessage_ConsoleIO_AudioFrame | PlainMessage<AgentSessionMessage_ConsoleIO_AudioFrame> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush
 */
declare class AgentSessionMessage_ConsoleIO_AudioPlaybackFlush extends Message<AgentSessionMessage_ConsoleIO_AudioPlaybackFlush> {
  constructor(data?: PartialMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFlush>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFlush";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;

  static equals(a: AgentSessionMessage_ConsoleIO_AudioPlaybackFlush | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFlush> | undefined, b: AgentSessionMessage_ConsoleIO_AudioPlaybackFlush | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFlush> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear
 */
declare class AgentSessionMessage_ConsoleIO_AudioPlaybackClear extends Message<AgentSessionMessage_ConsoleIO_AudioPlaybackClear> {
  constructor(data?: PartialMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackClear>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackClear";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackClear;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackClear;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackClear;

  static equals(a: AgentSessionMessage_ConsoleIO_AudioPlaybackClear | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackClear> | undefined, b: AgentSessionMessage_ConsoleIO_AudioPlaybackClear | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackClear> | undefined): boolean;
}

/**
 * @generated from message livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished
 */
declare class AgentSessionMessage_ConsoleIO_AudioPlaybackFinished extends Message<AgentSessionMessage_ConsoleIO_AudioPlaybackFinished> {
  constructor(data?: PartialMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFinished>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.agent.AgentSessionMessage.ConsoleIO.AudioPlaybackFinished";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;

  static equals(a: AgentSessionMessage_ConsoleIO_AudioPlaybackFinished | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFinished> | undefined, b: AgentSessionMessage_ConsoleIO_AudioPlaybackFinished | PlainMessage<AgentSessionMessage_ConsoleIO_AudioPlaybackFinished> | undefined): boolean;
}

type livekit_agent_session_pb_d_AgentConfigUpdate = AgentConfigUpdate;
declare const livekit_agent_session_pb_d_AgentConfigUpdate: typeof AgentConfigUpdate;
...
type livekit_agent_session_pb_d_AgentSessionEvent = AgentSessionEvent;
declare const livekit_agent_session_pb_d_AgentSessionEvent: typeof AgentSessionEvent;
type livekit_agent_session_pb_d_AgentSessionEvent_AgentStateChanged = AgentSessionEvent_AgentStateChanged;
declare const livekit_agent_session_pb_d_AgentSessionEvent_AgentStateChanged: typeof AgentSessionEvent_AgentStateChanged;
type livekit_agent_session_pb_d_AgentSessionEvent_AmdPrediction = AgentSessionEvent_AmdPrediction;
declare const livekit_agent_session_pb_d_AgentSessionEvent_AmdPrediction: typeof AgentSessionEvent_AmdPrediction;
type livekit_agent_session_pb_d_AgentSessionEvent_ConversationItemAdded = AgentSessionEvent_ConversationItemAdded;
declare const livekit_agent_session_pb_d_AgentSessionEvent_ConversationItemAdded: typeof AgentSessionEvent_ConversationItemAdded;
type livekit_agent_session_pb_d_AgentSessionEvent_Error = AgentSessionEvent_Error;
declare const livekit_agent_session_pb_d_AgentSessionEvent_Error: typeof AgentSessionEvent_Error;
type livekit_agent_session_pb_d_AgentSessionEvent_FunctionToolsExecuted = AgentSessionEvent_FunctionToolsExecuted;
declare const livekit_agent_session_pb_d_AgentSessionEvent_FunctionToolsExecuted: typeof AgentSessionEvent_FunctionToolsExecuted;
type livekit_agent_session_pb_d_AgentSessionEvent_OverlappingSpeech = AgentSessionEvent_OverlappingSpeech;
declare const livekit_agent_session_pb_d_AgentSessionEvent_OverlappingSpeech: typeof AgentSessionEvent_OverlappingSpeech;
type livekit_agent_session_pb_d_AgentSessionEvent_SessionUsageUpdated = AgentSessionEvent_SessionUsageUpdated;
declare const livekit_agent_session_pb_d_AgentSessionEvent_SessionUsageUpdated: typeof AgentSessionEvent_SessionUsageUpdated;
type livekit_agent_session_pb_d_AgentSessionEvent_UserInputTranscribed = AgentSessionEvent_UserInputTranscribed;
declare const livekit_agent_session_pb_d_AgentSessionEvent_UserInputTranscribed: typeof AgentSessionEvent_UserInputTranscribed;
type livekit_agent_session_pb_d_AgentSessionEvent_UserStateChanged = AgentSessionEvent_UserStateChanged;
declare const livekit_agent_session_pb_d_AgentSessionEvent_UserStateChanged: typeof AgentSessionEvent_UserStateChanged;
type livekit_agent_session_pb_d_AgentSessionMessage = AgentSessionMessage;
declare const livekit_agent_session_pb_d_AgentSessionMessage: typeof AgentSessionMessage;
type livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO = AgentSessionMessage_ConsoleIO;
declare const livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO: typeof AgentSessionMessage_ConsoleIO;
type livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioFrame = AgentSessionMessage_ConsoleIO_AudioFrame;
declare const livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioFrame: typeof AgentSessionMessage_ConsoleIO_AudioFrame;
type livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackClear = AgentSessionMessage_ConsoleIO_AudioPlaybackClear;
declare const livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackClear: typeof AgentSessionMessage_ConsoleIO_AudioPlaybackClear;
type livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFinished = AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;
declare const livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFinished: typeof AgentSessionMessage_ConsoleIO_AudioPlaybackFinished;
type livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFlush = AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;
declare const livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFlush: typeof AgentSessionMessage_ConsoleIO_AudioPlaybackFlush;
type livekit_agent_session_pb_d_AgentSessionUsage = AgentSessionUsage;
declare const livekit_agent_session_pb_d_AgentSessionUsage: typeof AgentSessionUsage;
type livekit_agent_session_pb_d_AgentState = AgentState;
declare const livekit_agent_session_pb_d_AgentState: typeof AgentState;
type livekit_agent_session_pb_d_AmdCategory = AmdCategory;
declare const livekit_agent_session_pb_d_AmdCategory: typeof AmdCategory;
...
type livekit_agent_session_pb_d_InterruptionModelUsage = InterruptionModelUsage;
declare const livekit_agent_session_pb_d_InterruptionModelUsage: typeof InterruptionModelUsage;
type livekit_agent_session_pb_d_LLMModelUsage = LLMModelUsage;
declare const livekit_agent_session_pb_d_LLMModelUsage: typeof LLMModelUsage;
...
type livekit_agent_session_pb_d_ModelUsage = ModelUsage;
declare const livekit_agent_session_pb_d_ModelUsage: typeof ModelUsage;
type livekit_agent_session_pb_d_STTModelUsage = STTModelUsage;
declare const livekit_agent_session_pb_d_STTModelUsage: typeof STTModelUsage;
type livekit_agent_session_pb_d_SessionRequest = SessionRequest;
declare const livekit_agent_session_pb_d_SessionRequest: typeof SessionRequest;
type livekit_agent_session_pb_d_SessionRequest_GetAgentInfo = SessionRequest_GetAgentInfo;
declare const livekit_agent_session_pb_d_SessionRequest_GetAgentInfo: typeof SessionRequest_GetAgentInfo;
type livekit_agent_session_pb_d_SessionRequest_GetChatHistory = SessionRequest_GetChatHistory;
declare const livekit_agent_session_pb_d_SessionRequest_GetChatHistory: typeof SessionRequest_GetChatHistory;
type livekit_agent_session_pb_d_SessionRequest_GetFrameworkInfo = SessionRequest_GetFrameworkInfo;
declare const livekit_agent_session_pb_d_SessionRequest_GetFrameworkInfo: typeof SessionRequest_GetFrameworkInfo;
type livekit_agent_session_pb_d_SessionRequest_GetRTCStats = SessionRequest_GetRTCStats;
declare const livekit_agent_session_pb_d_SessionRequest_GetRTCStats: typeof SessionRequest_GetRTCStats;
type livekit_agent_session_pb_d_SessionRequest_GetSessionState = SessionRequest_GetSessionState;
declare const livekit_agent_session_pb_d_SessionRequest_GetSessionState: typeof SessionRequest_GetSessionState;
type livekit_agent_session_pb_d_SessionRequest_GetSessionUsage = SessionRequest_GetSessionUsage;
declare const livekit_agent_session_pb_d_SessionRequest_GetSessionUsage: typeof SessionRequest_GetSessionUsage;
type livekit_agent_session_pb_d_SessionRequest_Ping = SessionRequest_Ping;
declare const livekit_agent_session_pb_d_SessionRequest_Ping: typeof SessionRequest_Ping;
type livekit_agent_session_pb_d_SessionRequest_RunInput = SessionRequest_RunInput;
declare const livekit_agent_session_pb_d_SessionRequest_RunInput: typeof SessionRequest_RunInput;
type livekit_agent_session_pb_d_SessionResponse = SessionResponse;
declare const livekit_agent_session_pb_d_SessionResponse: typeof SessionResponse;
type livekit_agent_session_pb_d_SessionResponse_GetAgentInfoResponse = SessionResponse_GetAgentInfoResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetAgentInfoResponse: typeof SessionResponse_GetAgentInfoResponse;
type livekit_agent_session_pb_d_SessionResponse_GetChatHistoryResponse = SessionResponse_GetChatHistoryResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetChatHistoryResponse: typeof SessionResponse_GetChatHistoryResponse;
type livekit_agent_session_pb_d_SessionResponse_GetFrameworkInfoResponse = SessionResponse_GetFrameworkInfoResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetFrameworkInfoResponse: typeof SessionResponse_GetFrameworkInfoResponse;
type livekit_agent_session_pb_d_SessionResponse_GetRTCStatsResponse = SessionResponse_GetRTCStatsResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetRTCStatsResponse: typeof SessionResponse_GetRTCStatsResponse;
type livekit_agent_session_pb_d_SessionResponse_GetSessionStateResponse = SessionResponse_GetSessionStateResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetSessionStateResponse: typeof SessionResponse_GetSessionStateResponse;
type livekit_agent_session_pb_d_SessionResponse_GetSessionUsageResponse = SessionResponse_GetSessionUsageResponse;
declare const livekit_agent_session_pb_d_SessionResponse_GetSessionUsageResponse: typeof SessionResponse_GetSessionUsageResponse;
type livekit_agent_session_pb_d_SessionResponse_Pong = SessionResponse_Pong;
declare const livekit_agent_session_pb_d_SessionResponse_Pong: typeof SessionResponse_Pong;
type livekit_agent_session_pb_d_SessionResponse_RunInputResponse = SessionResponse_RunInputResponse;
declare const livekit_agent_session_pb_d_SessionResponse_RunInputResponse: typeof SessionResponse_RunInputResponse;
type livekit_agent_session_pb_d_TTSModelUsage = TTSModelUsage;
declare const livekit_agent_session_pb_d_TTSModelUsage: typeof TTSModelUsage;
type livekit_agent_session_pb_d_TimedString = TimedString;
declare const livekit_agent_session_pb_d_TimedString: typeof TimedString;
type livekit_agent_session_pb_d_UserState = UserState;
declare const livekit_agent_session_pb_d_UserState: typeof UserState;
declare namespace livekit_agent_session_pb_d {
  export { livekit_agent_session_pb_d_AgentConfigUpdate as AgentConfigUpdate, livekit_agent_session_pb_d_AgentHandoff as AgentHandoff, livekit_agent_session_pb_d_AgentSessionEvent as AgentSessionEvent, livekit_agent_session_pb_d_AgentSessionEvent_AgentStateChanged as AgentSessionEvent_AgentStateChanged, livekit_agent_session_pb_d_AgentSessionEvent_AmdPrediction as AgentSessionEvent_AmdPrediction, livekit_agent_session_pb_d_AgentSessionEvent_ConversationItemAdded as AgentSessionEvent_ConversationItemAdded, livekit_agent_session_pb_d_AgentSessionEvent_Error as AgentSessionEvent_Error, livekit_agent_session_pb_d_AgentSessionEvent_FunctionToolsExecuted as AgentSessionEvent_FunctionToolsExecuted, livekit_agent_session_pb_d_AgentSessionEvent_OverlappingSpeech as AgentSessionEvent_OverlappingSpeech, livekit_agent_session_pb_d_AgentSessionEvent_SessionUsageUpdated as AgentSessionEvent_SessionUsageUpdated, livekit_agent_session_pb_d_AgentSessionEvent_UserInputTranscribed as AgentSessionEvent_UserInputTranscribed, livekit_agent_session_pb_d_AgentSessionEvent_UserStateChanged as AgentSessionEvent_UserStateChanged, livekit_agent_session_pb_d_AgentSessionMessage as AgentSessionMessage, livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO as AgentSessionMessage_ConsoleIO, livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioFrame as AgentSessionMessage_ConsoleIO_AudioFrame, livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackClear as AgentSessionMessage_ConsoleIO_AudioPlaybackClear, livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFinished as AgentSessionMessage_ConsoleIO_AudioPlaybackFinished, livekit_agent_session_pb_d_AgentSessionMessage_ConsoleIO_AudioPlaybackFlush as AgentSessionMessage_ConsoleIO_AudioPlaybackFlush, livekit_agent_session_pb_d_AgentSessionUsage as AgentSessionUsage, livekit_agent_session_pb_d_AgentState as AgentState, livekit_agent_session_pb_d_AmdCategory as AmdCategory, livekit_agent_session_pb_d_ChatContext as ChatContext, livekit_agent_session_pb_d_ChatContext_ChatItem as ChatContext_ChatItem, ChatMessage$1 as ChatMessage, livekit_agent_session_pb_d_ChatMessage_ChatContent as ChatMessage_ChatContent, livekit_agent_session_pb_d_ChatRole as ChatRole, livekit_agent_session_pb_d_FunctionCall as FunctionCall, livekit_agent_session_pb_d_FunctionCallOutput as FunctionCallOutput, livekit_agent_session_pb_d_InterruptionModelUsage as InterruptionModelUsage, livekit_agent_session_pb_d_LLMModelUsage as LLMModelUsage, livekit_agent_session_pb_d_MetricsReport as MetricsReport, livekit_agent_session_pb_d_ModelUsage as ModelUsage, livekit_agent_session_pb_d_STTModelUsage as STTModelUsage, livekit_agent_session_pb_d_SessionRequest as SessionRequest, livekit_agent_session_pb_d_SessionRequest_GetAgentInfo as SessionRequest_GetAgentInfo, livekit_agent_session_pb_d_SessionRequest_GetChatHistory as SessionRequest_GetChatHistory, livekit_agent_session_pb_d_SessionRequest_GetFrameworkInfo as SessionRequest_GetFrameworkInfo, livekit_agent_session_pb_d_SessionRequest_GetRTCStats as SessionRequest_GetRTCStats, livekit_agent_session_pb_d_SessionRequest_GetSessionState as SessionRequest_GetSessionState, livekit_agent_session_pb_d_SessionRequest_GetSessionUsage as SessionRequest_GetSessionUsage, livekit_agent_session_pb_d_SessionRequest_Ping as SessionRequest_Ping, livekit_agent_session_pb_d_SessionRequest_RunInput as SessionRequest_RunInput, livekit_agent_session_pb_d_SessionResponse as SessionResponse, livekit_agent_session_pb_d_SessionResponse_GetAgentInfoResponse as SessionResponse_GetAgentInfoResponse, livekit_agent_session_pb_d_SessionResponse_GetChatHistoryResponse as SessionResponse_GetChatHistoryResponse, livekit_agent_session_pb_d_SessionResponse_GetFrameworkInfoResponse as SessionResponse_GetFrameworkInfoResponse, livekit_agent_session_pb_d_SessionResponse_GetRTCStatsResponse as SessionResponse_GetRTCStatsResponse, livekit_agent_session_pb_d_SessionResponse_GetSessionStateResponse as SessionResponse_GetSessionStateResponse, livekit_agent_session_pb_d_SessionResponse_GetSessionUsageResponse as SessionResponse_GetSessionUsageResponse, livekit_agent_session_pb_d_SessionResponse_Pong as SessionResponse_Pong, livekit_agent_session_pb_d_SessionResponse_RunInputResponse as SessionResponse_RunInputResponse, livekit_agent_session_pb_d_TTSModelUsage as TTSModelUsage, livekit_agent_session_pb_d_TimedString as TimedString, livekit_agent_session_pb_d_UserState as UserState };
}
...
declare class MetricsRecordingHeader extends Message<MetricsRecordingHeader> {
  ...
  /**
   * @generated from field: google.protobuf.Timestamp room_start_time = 7;
   */
  roomStartTime?: Timestamp;
...
/**
 * @generated from enum livekit.PacketTrailerFeature
 */
declare enum PacketTrailerFeature {
  /**
...
declare class TrackInfo extends Message<TrackInfo> {
  ...
  /**
   * @generated from field: repeated livekit.PacketTrailerFeature packet_trailer_features = 21;
   */
...
declare class ClientInfo extends Message<ClientInfo> {
   ...
   *
   * @generated from field: repeated livekit.ClientInfo.Capability capabilities = 13;
   */
  capabilities: ClientInfo_Capability[];
 ...
 *
 * @generated from enum livekit.ClientInfo.Capability
 */
declare enum ClientInfo_Capability {
  /**
...
declare class Job extends Message<Job> {
  ...
  /**
   * @generated from field: string deployment = 11;
   */
  deployment: string;
...
declare class RegisterWorkerRequest extends Message<RegisterWorkerRequest> {
  ...
  /**
   * @generated from field: string deployment = 9;
   */
  deployment: string;
...
/**
 * @generated from enum livekit.JobRestartPolicy
 */
declare enum JobRestartPolicy {
  /**
   * restart when the job fails (default)
   *
   * @generated from enum value: JRP_ON_FAILURE = 0;
   */
  JRP_ON_FAILURE = 0,
   ...
   * never restart
   *
   * @generated from enum value: JRP_NEVER = 1;
   */
  JRP_NEVER = 1,
}
...
declare class CreateAgentDispatchRequest extends Message<CreateAgentDispatchRequest> {
   ...
   * cloud only
   *
   * @generated from field: livekit.JobRestartPolicy restart_policy = 4;
   */
...
declare class RoomAgentDispatch extends Message<RoomAgentDispatch> {
   ...
   * cloud only
   *
   * @generated from field: livekit.JobRestartPolicy restart_policy = 3;
   */
  restartPolicy: JobRestartPolicy;
...
declare class AgentDispatch extends Message<AgentDispatch> {
   ...
   * cloud only
   *
   * @generated from field: livekit.JobRestartPolicy restart_policy = 6;
   */
  restartPolicy: JobRestartPolicy;

  /**
   * @generated from field: string deployment = 7;
   */
  deployment: string;
...
/**
 * @generated from enum livekit.AudioChannel
 */
declare enum AudioChannel {
  /**
   * @generated from enum value: AUDIO_CHANNEL_BOTH = 0;
   */
  BOTH = 0,

  /**
   * @generated from enum value: AUDIO_CHANNEL_LEFT = 1;
   */
  LEFT = 1,

  /**
   * @generated from enum value: AUDIO_CHANNEL_RIGHT = 2;
   */
  RIGHT = 2,
}
...
declare enum StreamProtocol {
  ...
  /**
   * @generated from enum value: WEBSOCKET = 3;
   */
  WEBSOCKET = 3,
}
...
/**
 * @generated from message livekit.StartEgressRequest
 */
declare class StartEgressRequest extends Message<StartEgressRequest> {
  /**
  ...
  /**
   * @generated from oneof livekit.StartEgressRequest.source
   */
  source: {
    /**
     * @generated from field: livekit.TemplateSource template = 2;
     */
    value: TemplateSource;
    case: "template";
  } | {
    /**
     * @generated from field: livekit.WebSource web = 3;
     */
    value: WebSource;
    case: "web";
  } | {
    /**
     * @generated from field: livekit.MediaSource media = 4;
     */
    value: MediaSource;
    case: "media";
  } | { case: undefined; value?: undefined };
   ...
   *
   * @generated from oneof livekit.StartEgressRequest.encoding
   */
  encoding: {
    /**
     * @generated from field: livekit.EncodingOptionsPreset preset = 5;
     */
    value: EncodingOptionsPreset;
    case: "preset";
  } | {
    /**
     * @generated from field: livekit.EncodingOptions advanced = 6;
     */
   ...
   *
   * @generated from field: repeated livekit.Output outputs = 7;
   */
  outputs: Output[];
   ...
   *
   * @generated from field: livekit.StorageConfig storage = 8;
   */
   ...
   *
   * @generated from field: repeated livekit.WebhookConfig webhooks = 9;
   */
  webhooks: WebhookConfig[];

  constructor(data?: PartialMessage<StartEgressRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.StartEgressRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): StartEgressRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): StartEgressRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): StartEgressRequest;

  static equals(a: StartEgressRequest | PlainMessage<StartEgressRequest> | undefined, b: StartEgressRequest | PlainMessage<StartEgressRequest> | undefined): boolean;
}
 ...
 *
 * @generated from message livekit.TemplateSource
 */
declare class TemplateSource extends Message<TemplateSource> {
  /**
  ...
  constructor(data?: PartialMessage<TemplateSource>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.TemplateSource";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): TemplateSource;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): TemplateSource;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): TemplateSource;

  static equals(a: TemplateSource | PlainMessage<TemplateSource> | undefined, b: TemplateSource | PlainMessage<TemplateSource> | undefined): boolean;
}

/**
 * Record a custom URL via headless browser.
 *
 * @generated from message livekit.WebSource
 */
declare class WebSource extends Message<WebSource> {
  /**
   * @generated from field: string url = 1;
   */
  url: string;
  ...
  /**
   * @generated from field: bool await_start_signal = 4;
   */
  awaitStartSignal: boolean;

  constructor(data?: PartialMessage<WebSource>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.WebSource";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): WebSource;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): WebSource;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): WebSource;

  static equals(a: WebSource | PlainMessage<WebSource> | undefined, b: WebSource | PlainMessage<WebSource> | undefined): boolean;
}
 ...
 *
 * @generated from message livekit.MediaSource
 */
declare class MediaSource extends Message<MediaSource> {
  /**
   * @generated from oneof livekit.MediaSource.video
   */
  video: {
    /**
     * @generated from field: string video_track_id = 1;
     */
    value: string;
    case: "videoTrackId";
  } | {
    /**
     * @generated from field: livekit.ParticipantVideo participant_video = 2;
     */
  ...
  /**
   * @generated from field: livekit.AudioConfig audio = 3;
   */
  audio?: AudioConfig;

  /**
   * @generated from field: livekit.DataConfig data = 4;
   */
  data?: DataConfig;

  constructor(data?: PartialMessage<MediaSource>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.MediaSource";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): MediaSource;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): MediaSource;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): MediaSource;

  static equals(a: MediaSource | PlainMessage<MediaSource> | undefined, b: MediaSource | PlainMessage<MediaSource> | undefined): boolean;
}

/**
 * @generated from message livekit.ParticipantVideo
 */
declare class ParticipantVideo extends Message<ParticipantVideo> {
  /**
  ...
  /**
   * @generated from field: bool prefer_screen_share = 2;
   */
  preferScreenShare: boolean;

  constructor(data?: PartialMessage<ParticipantVideo>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.ParticipantVideo";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ParticipantVideo;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ParticipantVideo;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ParticipantVideo;

  static equals(a: ParticipantVideo | PlainMessage<ParticipantVideo> | undefined, b: ParticipantVideo | PlainMessage<ParticipantVideo> | undefined): boolean;
}
 ...
 *
 * @generated from message livekit.AudioConfig
 */
declare class AudioConfig extends Message<AudioConfig> {
  /**
   ...
   *
   * @generated from field: repeated livekit.AudioRoute routes = 1;
   */
  routes: AudioRoute[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.AudioConfig";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.AudioRoute
 */
declare class AudioRoute extends Message<AudioRoute> {
  /**
   * @generated from oneof livekit.AudioRoute.match
   */
  match: {
    /**
    ...
    /**
     * @generated from field: livekit.ParticipantInfo.Kind participant_kind = 3;
     */
    value: ParticipantInfo_Kind;
    case: "participantKind";
  } | { case: undefined; value?: undefined };

  /**
   * @generated from field: livekit.AudioChannel channel = 4;
   */
  channel: AudioChannel;

  constructor(data?: PartialMessage<AudioRoute>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.AudioRoute";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AudioRoute;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AudioRoute;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AudioRoute;

  static equals(a: AudioRoute | PlainMessage<AudioRoute> | undefined, b: AudioRoute | PlainMessage<AudioRoute> | undefined): boolean;
}

/**
 * @generated from message livekit.DataConfig
 */
declare class DataConfig extends Message<DataConfig> {
  /**
   * If empty, all data tracks captured.
   * If non-empty, only matching data tracks are captured.
   *
   * @generated from field: repeated livekit.DataSelector selectors = 1;
   */
  selectors: DataSelector[];

  constructor(data?: PartialMessage<DataConfig>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.DataConfig";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DataConfig;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DataConfig;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DataConfig;

  static equals(a: DataConfig | PlainMessage<DataConfig> | undefined, b: DataConfig | PlainMessage<DataConfig> | undefined): boolean;
}

/**
 * @generated from message livekit.DataSelector
 */
declare class DataSelector extends Message<DataSelector> {
  /**
   * @generated from oneof livekit.DataSelector.match
   */
  match: {
    /**
     * @generated from field: string track_id = 1;
  ...
  constructor(data?: PartialMessage<DataSelector>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.DataSelector";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): DataSelector;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): DataSelector;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): DataSelector;

  static equals(a: DataSelector | PlainMessage<DataSelector> | undefined, b: DataSelector | PlainMessage<DataSelector> | undefined): boolean;
}
...
declare class EncodingOptions extends Message<EncodingOptions> {
   ...
   *
   * @generated from field: int32 audio_quality = 11 [deprecated = true];
   * @deprecated
   */
  audioQuality: number;
   ...
   *
   * @generated from field: int32 video_quality = 12 [deprecated = true];
   * @deprecated
   */
  videoQuality: number;
...
/**
 * @generated from message livekit.Output
 */
declare class Output extends Message<Output> {
  /**
   * @generated from oneof livekit.Output.config
   */
  config: {
    /**
     * @generated from field: livekit.FileOutput file = 1;
     */
    value: FileOutput;
    case: "file";
  } | {
    /**
     * @generated from field: livekit.StreamOutput stream = 2;
     */
    value: StreamOutput;
    case: "stream";
  } | {
    /**
     * @generated from field: livekit.SegmentedFileOutput segments = 3;
     */
     ...
     * 5 reserved for mcap;
     *
     * @generated from field: livekit.ImageOutput images = 4;
     */
    value: ImageOutput;
    case: "images";
  } | { case: undefined; value?: undefined };
   ...
   *
   * @generated from field: livekit.StorageConfig storage = 6;
   */
  storage?: StorageConfig;
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.Output";
  static readonly fields: FieldList;
 ...
 *
 * @generated from message livekit.FileOutput
 */
declare class FileOutput extends Message<FileOutput> {
  /**
  ...
  /**
   * @generated from field: bool disable_manifest = 3;
   */
  disableManifest: boolean;

  constructor(data?: PartialMessage<FileOutput>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.FileOutput";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): FileOutput;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): FileOutput;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): FileOutput;

  static equals(a: FileOutput | PlainMessage<FileOutput> | undefined, b: FileOutput | PlainMessage<FileOutput> | undefined): boolean;
}
...
/**
 * @generated from message livekit.StorageConfig
 */
declare class StorageConfig extends Message<StorageConfig> {
  /**
   * @generated from oneof livekit.StorageConfig.provider
   */
  provider: {
    /**
     * @generated from field: livekit.S3Upload s3 = 1;
     */
    value: S3Upload;
    case: "s3";
  } | {
    /**
     * @generated from field: livekit.GCPUpload gcp = 2;
     */
    value: GCPUpload;
    case: "gcp";
  } | {
    /**
     * @generated from field: livekit.AzureBlobUpload azure = 3;
     */
    value: AzureBlobUpload;
    case: "azure";
  } | {
    /**
     * @generated from field: livekit.AliOSSUpload aliOSS = 4;
     */
    value: AliOSSUpload;
    case: "aliOSS";
  } | { case: undefined; value?: undefined };
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.StorageConfig";
  static readonly fields: FieldList;
...
/**
 * @generated from message livekit.UpdateEgressRequest
 */
declare class UpdateEgressRequest extends Message<UpdateEgressRequest> {
  /**
  ...
  /**
   * @generated from field: repeated string add_stream_urls = 4;
   */
  addStreamUrls: string[];

  /**
   * @generated from field: repeated string remove_stream_urls = 5;
   */
  removeStreamUrls: string[];

  constructor(data?: PartialMessage<UpdateEgressRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.UpdateEgressRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): UpdateEgressRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): UpdateEgressRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): UpdateEgressRequest;

  static equals(a: UpdateEgressRequest | PlainMessage<UpdateEgressRequest> | undefined, b: UpdateEgressRequest | PlainMessage<UpdateEgressRequest> | undefined): boolean;
}
...
declare class EgressInfo extends Message<EgressInfo> {
  ...
  request: {
     ...
     *
     * @generated from field: livekit.ExportReplayRequest replay = 30;
     */
    value: ExportReplayRequest;
    case: "replay";
  } | {
    /**
...
/**
 * @generated from message livekit.ExportReplayRequest
 */
declare class ExportReplayRequest extends Message<ExportReplayRequest> {
  /**
  ...
  /**
   * @generated from field: int64 end_offset_ms = 3;
   */
  endOffsetMs: bigint;

  /**
   * @generated from oneof livekit.ExportReplayRequest.source
   */
  source: {
    /**
     * @generated from field: livekit.TemplateSource template = 4;
     */
    value: TemplateSource;
    case: "template";
  } | {
    /**
     * @generated from field: livekit.WebSource web = 5;
     */
    value: WebSource;
    case: "web";
  } | {
    /**
     * @generated from field: livekit.MediaSource media = 6;
     */
    value: MediaSource;
    case: "media";
  } | { case: undefined; value?: undefined };
  ...
  /**
   * @generated from oneof livekit.ExportReplayRequest.encoding
   */
  encoding: {
    /**
  ...
  /**
   * @generated from field: repeated livekit.Output outputs = 9;
   */
  outputs: Output[];

  /**
   * @generated from field: livekit.StorageConfig storage = 10;
   */
  storage?: StorageConfig;

  /**
   * @generated from field: repeated livekit.WebhookConfig webhooks = 11;
   */
  webhooks: WebhookConfig[];

  constructor(data?: PartialMessage<ExportReplayRequest>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.ExportReplayRequest";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ExportReplayRequest;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ExportReplayRequest;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ExportReplayRequest;

  static equals(a: ExportReplayRequest | PlainMessage<ExportReplayRequest> | undefined, b: ExportReplayRequest | PlainMessage<ExportReplayRequest> | undefined): boolean;
}
...
/**
 * @generated from message livekit.SIPCodec
 */
declare class SIPCodec extends Message<SIPCodec> {
  /**
   * @generated from field: string name = 1;
   */
  name: string;
  ...
  constructor(data?: PartialMessage<SIPCodec>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SIPCodec";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SIPCodec;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SIPCodec;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SIPCodec;

  static equals(a: SIPCodec | PlainMessage<SIPCodec> | undefined, b: SIPCodec | PlainMessage<SIPCodec> | undefined): boolean;
}

/**
 * @generated from message livekit.SIPMediaConfig
 */
declare class SIPMediaConfig extends Message<SIPMediaConfig> {
  /**
   * if set, ignore the default codecs and use the list below.
   *
   * @generated from field: bool only_listed_codecs = 1;
   */
  onlyListedCodecs: boolean;

  /**
   * List of allowed codecs. If only_listed_codecs is not set, this list is added to default codecs.
   *
   * @generated from field: repeated livekit.SIPCodec codecs = 2;
   */
  codecs: SIPCodec[];

  /**
   * @generated from field: optional livekit.SIPMediaEncryption encryption = 3;
   */
  encryption?: SIPMediaEncryption;

  constructor(data?: PartialMessage<SIPMediaConfig>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.SIPMediaConfig";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): SIPMediaConfig;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): SIPMediaConfig;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): SIPMediaConfig;

  static equals(a: SIPMediaConfig | PlainMessage<SIPMediaConfig> | undefined, b: SIPMediaConfig | PlainMessage<SIPMediaConfig> | undefined): boolean;
}
...
declare class SIPOutboundTrunkInfo extends Message<SIPOutboundTrunkInfo> {
   ...
   *
   * @generated from field: string from_host = 15;
   */
  fromHost: string;
...
declare class SIPOutboundTrunkUpdate extends Message<SIPOutboundTrunkUpdate> {
  ...
  /**
   * @generated from field: optional string from_host = 10;
   */
  fromHost?: string;
...
declare class SIPDispatchRuleIndividual extends Message<SIPDispatchRuleIndividual> {
   ...
   *
   * @generated from field: bool no_randomness = 3;
   */
...
declare class SIPDispatchRuleInfo extends Message<SIPDispatchRuleInfo> {
  ...
  /**
   * @generated from field: livekit.SIPMediaConfig media = 16;
   */
  ...
  /**
   * @generated from field: livekit.SIPMediaEncryption media_encryption = 12 [deprecated = true];
   * @deprecated
   */
  mediaEncryption: SIPMediaEncryption;
...
declare class SIPDispatchRuleUpdate extends Message<SIPDispatchRuleUpdate> {
  ...
  /**
   * @generated from field: optional livekit.SIPMediaEncryption media_encryption = 6 [deprecated = true];
   * @deprecated
   */
  mediaEncryption?: SIPMediaEncryption;

  /**
   * @generated from field: livekit.SIPMediaConfig media = 7;
   */
  media?: SIPMediaConfig;
...
declare class SIPOutboundConfig extends Message<SIPOutboundConfig> {
   ...
   *
   * @generated from field: string from_host = 8;
   */
  fromHost: string;
...
declare class CreateSIPParticipantRequest extends Message<CreateSIPParticipantRequest> {
  ...
  /**
   * @generated from field: livekit.SIPMediaEncryption media_encryption = 18 [deprecated = true];
   * @deprecated
   */
  mediaEncryption: SIPMediaEncryption;

  /**
   * @generated from field: livekit.SIPMediaConfig media = 23;
   */
  media?: SIPMediaConfig;
 ...
 */
declare class AnalyticsVideoLayer extends Message<AnalyticsVideoLayer> {
  /**
 ...
 */
declare class AnalyticsStream extends Message<AnalyticsStream> {
  /**
 ...
 */
declare class AnalyticsStat extends Message<AnalyticsStat> {
  /**
 ...
 */
declare class AnalyticsStats extends Message<AnalyticsStats> {
  /**
 ...
 */
declare class AnalyticsClientMeta extends Message<AnalyticsClientMeta> {
  /**
 ...
 */
declare class AnalyticsEvent extends Message<AnalyticsEvent> {
  /**
 ...
 */
declare class AnalyticsEvents extends Message<AnalyticsEvents> {
  /**
 ...
 */
declare class AnalyticsRoomParticipant extends Message<AnalyticsRoomParticipant> {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
 ...
 */
declare class AnalyticsRoom extends Message<AnalyticsRoom> {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
 ...
 */
declare class AnalyticsNodeRooms extends Message<AnalyticsNodeRooms> {
  /**
 ...
 */
declare class ReportInfo extends Message<ReportInfo> {
  /**
 ...
 */
declare class TimeRange extends Message<TimeRange> {
  /**
 ...
 */
declare class FeatureUsageInfo extends Message<FeatureUsageInfo> {
  /**
   ...
   *
   * @generated from field: map<string, string> feature_info = 9;
   */
  featureInfo: { [key: string]: string };
 ...
 */
declare enum FeatureUsageInfo_Feature {
  /**
 ...
 */
declare class APICallRequest extends Message<APICallRequest> {
  /**
 ...
 */
declare class APICallInfo extends Message<APICallInfo> {
  /**
 ...
 */
declare class WebhookInfo extends Message<WebhookInfo> {
  /**
...
declare class AddTrackRequest extends Message<AddTrackRequest> {
  ...
  /**
   * @generated from field: repeated livekit.PacketTrailerFeature packet_trailer_features = 18;
   */
  packetTrailerFeatures: PacketTrailerFeature[];
...
declare class DialWhatsAppCallRequest extends Message<DialWhatsAppCallRequest> {
   ...
   * Max time for the callee to answer the call.
   *
   * @generated from field: google.protobuf.Duration ringing_timeout = 13;
   */
  ringingTimeout?: Duration;
...
declare class AcceptWhatsAppCallRequest extends Message<AcceptWhatsAppCallRequest> {
   ...
   * Max time for the callee to answer the call.
   *
   * @generated from field: google.protobuf.Duration ringing_timeout = 14;
   */
  ringingTimeout?: Duration;
   ...
   * Wait for the answer for the call before returning.
   *
   * @generated from field: bool wait_until_answered = 15;
   */
  waitUntilAnswered: boolean;
