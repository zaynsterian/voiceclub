...
export const NodeStats = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 51, name: "num_track_publish_cancels", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    ...
    { no: 52, name: "num_track_subscribe_cancels", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
    ...
    { no: 53, name: "participant_rtc_canceled", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
export const NodeStatsRate = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 24, name: "track_publish_cancels", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
    ...
    { no: 25, name: "track_subscribe_cancels", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
    ...
    { no: 26, name: "participant_rtc_canceled", kind: "scalar", T: 2 /* ScalarType.FLOAT */ },
...
export const StartSession = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 25, name: "auto_subscribe_data_track", kind: "scalar", T: 8 /* ScalarType.BOOL */, opt: true },
...
export const RoomInternal = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "export_room", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
