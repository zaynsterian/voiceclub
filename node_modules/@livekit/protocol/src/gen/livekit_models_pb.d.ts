 ...
 */
export declare enum DataTrackExtensionID {
  /**
 ...
 */
export declare class DataTrackExtensionParticipantSid extends Message<DataTrackExtensionParticipantSid> {
  /**
 ...
 */
export declare class DataTrackSubscriptionOptions extends Message<DataTrackSubscriptionOptions> {
  /**
 ...
 */
export declare enum ClientInfo_Capability {
  /**
