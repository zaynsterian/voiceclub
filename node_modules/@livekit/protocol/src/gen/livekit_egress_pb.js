...
import { AudioCodec, ImageCodec, ParticipantInfo_Kind, VideoCodec, WebhookConfig } from "./livekit_models_pb.js";

/**
 * @generated from enum livekit.AudioChannel
 */
export const AudioChannel = /*@__PURE__*/ proto3.makeEnum(
 ...
 */
export const StartEgressRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 5, name: "preset", kind: "enum", T: proto3.getEnumType(EncodingOptionsPreset), oneof: "encoding" },
 ...
 */
export const TemplateSource = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "custom_base_url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
 ...
 */
export const WebSource = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.WebSource",
  () => [
    { no: 1, name: "url", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "audio_only", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 3, name: "video_only", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 4, name: "await_start_signal", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ],
);
 ...
 */
export const MediaSource = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.MediaSource",
  () => [
    { no: 1, name: "video_track_id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "video" },
 ...
 */
export const ParticipantVideo = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.ParticipantVideo",
  () => [
    { no: 1, name: "identity", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "prefer_screen_share", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ],
);
 ...
 */
export const AudioConfig = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.AudioConfig",
  () => [
 ...
 */
export const AudioRoute = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.AudioRoute",
  () => [
    { no: 1, name: "track_id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "match" },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "match" },
 ...
 */
export const DataConfig = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.DataConfig",
  () => [
 ...
 */
export const DataSelector = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.DataSelector",
  () => [
    { no: 1, name: "track_id", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "match" },
    { no: 2, name: "participant_identity", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "match" },
    { no: 3, name: "topic", kind: "scalar", T: 9 /* ScalarType.STRING */, oneof: "match" },
  ],
);
 ...
 */
export const UpdateEgressRequest = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "add_stream_urls", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
    { no: 5, name: "remove_stream_urls", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ],
);
...
export const EgressInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 27, name: "retry_count", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
...
export const StreamInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "last_retry_at", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 8, name: "retries", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
  ],
);
 ...
 */
export const ExportReplayRequest = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.ExportReplayRequest",
  () => [
    { no: 1, name: "replay_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "start_offset_ms", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "end_offset_ms", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
