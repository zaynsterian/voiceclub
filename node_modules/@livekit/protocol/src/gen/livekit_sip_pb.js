 ...
 */
export const SIPCodec = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.SIPCodec",
  () => [
 ...
 */
export const SIPMediaConfig = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.SIPMediaConfig",
  () => [
    { no: 1, name: "only_listed_codecs", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
...
export const ProviderInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 4, name: "prevent_transfer", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ],
);
...
export const SIPOutboundTrunkInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 15, name: "from_host", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
export const SIPOutboundTrunkUpdate = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "metadata", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
    { no: 8, name: "media_encryption", kind: "enum", T: proto3.getEnumType(SIPMediaEncryption), opt: true },
    { no: 10, name: "from_host", kind: "scalar", T: 9 /* ScalarType.STRING */, opt: true },
  ],
);
...
export const SIPDispatchRuleIndividual = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 2, name: "pin", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "no_randomness", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ],
);
...
export const SIPDispatchRuleInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 13, name: "numbers", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
...
export const SIPOutboundConfig = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 8, name: "from_host", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
...
export const SIPCallInfo = /*@__PURE__*/ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 28, name: "sip_call_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ],
);
